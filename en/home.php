...
<header>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <form class="d-flex">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
              <li class="nav-item">
                <a class="nav-link " aria-current="page" href="../index.php">ES</a>
              </li>
              <li class="nav-item">
                <a class="nav-link activado" aria-current="page" href="home.php">EN</a>
              </li>
            </ul>
          </form>
        </div>
    ...
    <main class="container">
        ...
        <div class="row">
            <div class="col-12 text-center mt-5">
                <h7>Welcome to my website</h7>
            </div>
            <div class="col-12 text-center">    
                <h7>Learn more about me on other platforms</h7>
            </div>
